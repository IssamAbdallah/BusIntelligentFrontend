  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <p className="text-gray-700">Total des bus: 12</p>
        <p className="text-gray-700">Bus actifs: 8</p>
        <p className="text-gray-700">Élèves: 245</p>
      </div>
      
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg font-medium mb-2">Alertes récentes</h3>
        <div className="text-red-500">Bus #3 en retard (15 min)</div>
        <div className="text-yellow-500 mt-1">Bus #7 hors itinéraire</div>
      </div>
